...
const logo = <img src="assets/img/xide.png" alt="xide" style={{height: "200px"}}/>; {/* <svg id="Ebene_2" data-name="Ebene 2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 105 100">
