...
`@remix-project/remix-debug` is a tool to debug Ethereum transactions on different Remix environments (VM, testnet etc.). It works underneath XIDE "DEBUGGER" plugin which is used to analyse step-to-step executioon of a transaction to debug it.
